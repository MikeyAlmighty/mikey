...
function Page() {
  return (
    <div className='lg:text-center bg-gray-100 lg:p-11'>
      <h1 className='lg:text-6xl text-4xl pt-12 lg:pt-4 lg:mt-0 text-lime-500 font-bold text-center'>Michael Leibbrandt</h1>
      ...
      >
        <TechBackgroundImage className='place-content-center w-full' height='25vh' />
      </motion.div>
      <Card data={cardData} />
